...
class TrialPeriod extends Resource
{
  use HasPermissions;
  ...
  {
    $labels = [
      'trial_duration' => __('Trial Duration'),
      'trial_deposit_amount' => __('Trial Deposit Amount'),
    ];
